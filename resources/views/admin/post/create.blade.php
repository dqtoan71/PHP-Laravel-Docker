...
<div class="row">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">{{ __('admin.Create New Post') }}</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('post-management.store') }}"  role="form" enctype="multipart/form-data">
                @csrf
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#">{{ __('admin.Create Post') }}</a></li>
</ol>
@endsection