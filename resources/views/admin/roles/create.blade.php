                                                ...
                                                @if (isset($listPermissions))
                                                    @foreach($listPermissions as $indexKey => $itemPermission)
                                                        ...
                                                        @if ($strCont != substr($itemPermission->name, 0, strpos($itemPermission->name,"-")) && $indexKey === 0)
                                                            ...
                                                            <label class="nameCont">{{ __('admin.' . ucfirst($strCont)) }}<input type="checkbox" rel="{{ $strCont }}" class="check_permissions_by_cont form-check-input" /></label>
                                                            <div class="block">
                                                        @elseif ($strCont != substr($itemPermission->name, 0, strpos($itemPermission->name,"-")) && $indexKey !== 0)
                                                                ...
                                                                <label class="nameCont">{{ __('admin.' . ucfirst($strCont)) }}<input type="checkbox" rel="{{ $strCont }}" class="check_permissions_by_cont form-check-input" /></label><div class="block">
                                                        @endif
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <label for="">{{ __('admin.' . $itemPermission->name) }}</label>
                                                        </div>
